    ...
    steps: [
      ...
      },
      {
        ...
        options: [
          ...
          { text: '~120 mtCO₂e/yr', correct: true, explanation: 'Right. 245 MWh × 1,079 lb/MWh = 264,355 lb × 0.4536 = 119,911 kg ≈ 120 mtCO₂e — about 31% of the entire Scope 2 figure (~390 mt). Pricing this at the INVENTORY average instead would give ~57 mt and understate the array by roughly half: that rate answers what we report, not what changed.' },
