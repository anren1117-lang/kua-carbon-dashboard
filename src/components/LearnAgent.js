...
const paths = [
...

  {
    ...
    steps: [
      {
        type: 'concept',
        heading: 'KUA\'s headline number is ~2,566 mtCO₂e/year',
        body: 'That\'s the NET balance — gross emissions minus on-campus sequestration. The composite range across all method combinations is 1,007–5,064 mt because most of the inputs are estimates. Once measured data fills in, the range tightens.',
      },
      {
        type: 'concept',
        heading: 'AP Stats: range, point estimate, and uncertainty',
        body: 'A point estimate (2,566) by itself is misleading without an uncertainty range. Our composite cross-check range is 1,007–5,064 — meaning the "true" value is most plausibly somewhere in that band. AP Statistics calls this a confidence interval. The width of the interval comes from the uncertainty in each line item: Scope 1 published-method range 895–1,875, Scope 3 1,802–3,779, sinks 1,000–2,100 — the sinks band is the widest, and it is why the net range below is so broad. These uncertainties propagate.',
      },
      {
        type: 'concept',
        heading: 'Where does the headline come from?',
        body: 'Gross: ~4,395 mtCO₂e/yr (Scope 1 ~1,350 + Scope 2 ~410 + Scope 3 ~2,635). Sequestration: ~1,829 mtCO₂e/yr drawdown on a net basis. Net: 4,395 − 1,829 = 2,566.',
      },
      {
        type: 'quiz',
        ...
        options: [
          ...
          { text: '~60%', correct: true, explanation: 'Right. **~2,635 of ~4,395 mtCO₂e gross is Scope 3** — about 60%. Inside Scope 3 itself, purchased goods (EEIO Cat 1 spend-based) leads followed by student travel (international + US-boarder term-break flights). Scope 1 (~1,350) and Scope 2 (~410) together are only ~40%. Kool (2025) found a similar Scope-3-dominant pattern at Royal Roads University.' },
          { text: '~90%', correct: false, explanation: 'Too high — Scope 1 and 2 still total ~40% (1,740/4,395). Scope 3 dominates but doesn\'t exclude the others.' },
        ],
      },
      {
        type: 'math',
...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        scenario: 'Treat KUA as having ~1,000 acres of forested land — our own working figure, taken from a published 1,300-acre campus. Use Birdsey (1992) US average rate: 1,252 lb C/acre/yr. Convert to mtCO₂e/yr.',
        given: [
...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        scenario: 'The 245,000 kWh from your rooftop solar is mostly self-consumed by KUA, DISPLACING grid electricity. Displacement is not consumption: solar backs down whichever plant is running at the margin, and that plant is dirtier than the grid average. EPA AVERT puts New England rooftop PV at 0.4896 kg CO₂ per kWh, or 1,079 lb per MWh.',
        given: [
          { label: 'Self-consumed solar', value: '245,000 kWh' },
          { label: 'AVERT marginal rate', value: '1,079 lb CO₂ / MWh' },
          { label: 'lb → kg', value: '× 0.4536' },
        ],
        question: 'Annual avoided emissions:',
        options: [
          { text: '~12 mtCO₂e/yr', correct: false, explanation: 'Off by 10× (probably an extra unit conversion).' },
          { text: '~120 mtCO₂e/yr', correct: true, explanation: 'Right. 245 MWh × 1,079 lb/MWh = 264,355 lb × 0.4536 = 119,911 kg ≈ 120 mtCO₂e — about 31% of the entire Scope 2 figure (~410 mt). Pricing this at the INVENTORY average instead would give ~57 mt and understate the array by roughly half: that rate answers what we report, not what changed.' },
          { text: '~1,200 mtCO₂e/yr', correct: false, explanation: 'Way too high — probably forgot kg → mt.' },
          { text: '~264 mtCO₂e/yr', correct: false, explanation: 'You may have stopped at lb without converting to kg (×0.4536) or mt.' },
        ],
      },
      {
        type: 'concept',
      ...
      },
      {
        ...
        given: [
          ...
          { label: 'Grid factor', value: '0.246 kg CO₂/kWh (location-based inventory rate)' },
        ],
        ...
        options: [
          ...
          { text: '~43 mtCO₂e/yr', correct: true, explanation: 'Right. OLD: 6,000 × 10.21 = 61.3 mt. NEW: 6,000 × 138,500 × 0.80 = 665M BTU; ÷ 3,412 = 195,000 kWh thermal; ÷ 2.5 = 78,000 kWh electric; × 0.246 = 18.3 mt. Savings = 61.3 − 18.3 = 43.0 mtCO₂e/yr. Worth knowing: 0.246 is the INVENTORY rate — the average of everything on the grid — and it answers "what does KUA now report?" If you instead ask "what does the atmosphere actually see?", you need the MARGINAL rate for the plants that ramp to serve new load (~0.49 kg/kWh via EPA AVERT), which gives ~38 mt of new emissions and only ~23 mt of real savings. Same retrofit, same kilowatt-hours, two different questions.' },
    ...
    steps: [
      {
        ...
        body: 'Each bar splits a school\'s per-student emissions by scope, with sinks and offsets to the LEFT of zero. Boarding-secondary peers cluster on a similar shape (heavy heating + heavy travel). Middlebury\'s "net zero" came mostly from real reductions, with the remainder credited from forest they own — so read it as a different accounting treatment, not a hollow claim.',
      },
      {
        type: 'quiz',
      ...
      },
      {
        ...
        body: 'Many institutions claim **"carbon neutral"** status. Reading the fine print is important — these claims vary enormously in what they actually represent.\n\n**The strongest version:** the institution has reduced its measured emissions to near-zero through real reductions (electrification, energy efficiency, clean electricity procurement, building retrofits) AND any residual emissions are offset by physical removal on owned land. Very few institutions reach this standard. Costs decades of investment.\n\n**The middle version:** the institution has reduced emissions partially and offsets the rest with a **mix** of physical sequestration on its own land and high-quality purchased offsets (third-party verified, with clear additionality and permanence). Better than the alternative but depends entirely on offset quality.\n\n**The weakest version:** the institution buys offsets equal to its gross emissions, claims neutrality, but emissions haven\'t actually fallen. The offsets may be cheap, low-quality, and have questionable additionality. This is the most common form of "neutrality" claim, and the most criticized.\n\nMiddlebury\'s "net zero" status (achieved in 2016) is the middle version, and on the documented record it leans toward the strong one: a $12M biomass plant cut No. 6 fuel oil by 91%, three solar arrays supply ~8% of electricity, 87 efficiency projects saved 4.52M kWh, and the residual was closed with credits quantified from their own 2,100 acres of Bread Loaf forestland under a Vermont Land Trust easement. The gross emissions are still real, but the balancing carbon is physically on their land. KUA differs in treatment rather than substance: the campus forest is reported as a sink inside the inventory instead of being monetised as credits.\n\n**Practical takeaway:** when you see a "net zero" claim, look for the breakdown. How much is reduction? How much is on-campus sequestration? How much is purchased offsets? The ratio tells you whether the claim represents real environmental impact or just accounting choices.',
      },
      {
        type: 'concept',
        heading: 'Sink or credit? Middlebury and KUA made different choices about the same kind of carbon',
        body: 'It is tempting to say Middlebury "just bought its way to neutral". The record says otherwise: most of the gap was closed by real reductions (biomass, solar, efficiency), and the remainder by credits quantified from their own 2,100-acre Bread Loaf forest under a permanent easement. So both schools have real trees pulling real carbon. The difference is where that carbon is booked — KUA reports it as a SINK inside its inventory, Middlebury converted theirs into tradable CREDITS. Worth knowing because the two routes look identical in a net figure and are not identical in what they commit you to: a credit is sold once and must stay unlogged forever to remain valid.',
      },
      {
        type: 'quiz',
      ...
      },
      {
        ...
        options: [
          ...
          { text: 'Verify they used the same scope inclusions, denominator, and methodology before comparing', correct: true, explanation: 'Right. **Comparison requires methodology parity.** Did both count Scope 3 fully? Both use the same denominator (FTE vs headcount)? Both measure on-campus sinks? If any of those differ, the apparent comparison may be a methodology artifact. Valls-Val & Bovea (2021) found exactly this across their review of 35 university footprint studies: no standardisation of the time metric, the functional unit (student vs employee vs floor area), or the data-collection boundary.' },
    ...
    steps: [
      ...
      },
      {
        ...
        options: [
          ...
          { text: 'Buying offsets equal to KUA\'s gross emissions', correct: false, explanation: 'Offsets equal gross would account for ~4,395 mt on paper, but the offset quality varies and KUA\'s emissions don\'t actually fall. Reduction wins over offsetting per dollar of effort.' },
        ],
      },
      {
        type: 'math',
    ...
    steps: [
      {
        ...
        body: 'No single student\'s choices solve climate change. But high-emitting individuals (frequent flyers, big homes, beef-heavy diets) have outsized footprints, and choices send market signals. Cordero et al. (2020) surveyed students five or more years after they calculated their own footprints and still found measurable behaviour change — roughly 2.9 tCO₂e/year per graduate. The educational value is real even when per-person tons are small.',
      },
      {
        type: 'concept',
      ...
      },
      {
        ...
        options: [
          ...
          { text: 'International round-trip flights home', correct: true, explanation: 'Right. **A single round-trip to East Asia ≈ 3.7 mtCO₂e** on the cohort-weighted central — close to a third of a KUA student\'s gross school-related footprint (~12.9 mt), in one trip. Two round trips a year (winter + summer) comes to well over half of it.' },
