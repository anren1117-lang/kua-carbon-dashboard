...
export const buildings = [
  ...
  { id: 'b_barrette',   bmsNumber:  9, name: 'Barrette',                   category: 'Dorm',     sqft: 22000, occupants: 60,  dormPopulation: 60,  hvacSchedule: '24/7',                  setpointHeatingF: 70, setpointCoolingF: 74 },
  { id: 'b_kilton',     bmsNumber: 18, name: 'Kilton House',               category: 'Dorm',     sqft: 16000, occupants: 36,  dormPopulation: 36,  hvacSchedule: '24/7',                  setpointHeatingF: 70, setpointCoolingF: 74 },
  ...
  { id: 'b_chellis',    bmsNumber: 22, name: 'Chellis Hall',               category: 'Dorm',     sqft: 8000,  occupants: 24,  dormPopulation: 24,  hvacSchedule: '24/7',                  setpointHeatingF: 70, setpointCoolingF: 74 },
  { id: 'b_welch',      bmsNumber: 17, name: 'Welch House',                category: 'Dorm',     sqft: 8500,  occupants: 22,  dormPopulation: 22,  hvacSchedule: '24/7',                  setpointHeatingF: 70, setpointCoolingF: 74 },
  { id: 'b_dexter',     bmsNumber: 15, name: 'Dexter-Richards Hall',       category: 'Dorm',     sqft: 9000,  occupants: 28,  dormPopulation: 28,  hvacSchedule: '24/7',                  setpointHeatingF: 70, setpointCoolingF: 74 },
  { id: 'b_densmore',   bmsNumber: 13, name: 'Densmore Hall',              category: 'Dorm',     sqft: 8200,  occupants: 26,  dormPopulation: 26,  hvacSchedule: '24/7',                  setpointHeatingF: 70, setpointCoolingF: 74 },
  { id: 'b_kurth',      bmsNumber: 21, name: 'Kurth Hall',                 category: 'Dorm',     sqft: 7600,  occupants: 22,  dormPopulation: 22,  hvacSchedule: '24/7',                  setpointHeatingF: 70, setpointCoolingF: 74 },
  { id: 'b_baxter',     bmsNumber:  1, name: 'Baxter',                     category: 'Dorm',     sqft: 6800,  occupants: 18,  dormPopulation: 18,  hvacSchedule: '24/7',                  setpointHeatingF: 70, setpointCoolingF: 74 },
  { id: 'b_bryant',     bmsNumber: 14, name: 'Bryant Hall',                category: 'Dorm',     sqft: 6500,  occupants: 18,  dormPopulation: 18,  hvacSchedule: '24/7',                  setpointHeatingF: 70, setpointCoolingF: 74 },
  { id: 'b_rowe',       bmsNumber: 16, name: 'Rowe Hall',                  category: 'Dorm',     sqft: 6300,  occupants: 16,  dormPopulation: 16,  hvacSchedule: '24/7',                  setpointHeatingF: 70, setpointCoolingF: 74 },
  { id: 'b_bishop',     bmsNumber:  3, name: 'Bishop Alumni House',        category: 'Dorm',     sqft: 5400,  occupants: 12,  dormPopulation: 12,  hvacSchedule: '24/7',                  setpointHeatingF: 70, setpointCoolingF: 74 },
  ...
  { id: 'b_mikula',     bmsNumber: 23, name: 'Mikula Hall',                category: 'Dorm',     sqft: 5800,  occupants: 14,  dormPopulation: 14,  hvacSchedule: '24/7',                  setpointHeatingF: 70, setpointCoolingF: 74 },
