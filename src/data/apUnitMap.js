...
export const apUnitMap = [
  {
    ...
    units: [
      ...
      },
      {
        ...
        name: 'Global Change',
        fit: 'direct',
        hook: 'Open /scenarios. Use the simulator to show how local action (one school, 1,725 mtCO₂e) scales to global context. 1 KUA = 0.00003% of global emissions — discuss whether that fact discourages or motivates action.',
...

  {
    ...
    units: [
      ...
      },
      {
        ...
        fit: 'direct',
        hook: 'Ocean acidification — same equilibrium as Unit 7, now quantitative. Compute ΔpH from a 100-ppm rise in atmospheric CO₂. Connect back to KUA\'s 1,725 mtCO₂e contribution.',
        dashboardPages: ['/methodology', '/'],
        linkedLessonIds: [],
      },
      {
...

  {
    ...
    units: [
      ...
      { num: 6, name: 'Market Failure and the Role of Government', fit: 'direct', hook: 'Carbon = textbook negative externality. Apply the deadweight loss + Pigouvian tax framework to KUA\'s 1,725 mtCO₂e. Connect to the MAC curve lesson.', dashboardPages: ['/scenarios', '/executive', '/'], linkedLessonIds: ['l_macc_curve', 'l_peer_compare'] },
    ],
  },
