...
export const apUnitMap = [
  {
    ...
    units: [
      ...
      },
      {
        ...
        name: 'Global Change',
        fit: 'direct',
        hook: 'Open /scenarios. Use the simulator to show how local action (one school, roughly 2,550 mtCO₂e net) scales to global context. 1 KUA = 0.00003% of global emissions — discuss whether that fact discourages or motivates action.',
