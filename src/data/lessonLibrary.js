...
export const lessonLibrary = [
  ...
  },
  {
    ...
    studentTask: 'Given KUA\'s rough scope splits (1: ~1,350 mt, 2: ~410 mt, 3: ~2,635 mt), pick the scope most reducible without the school giving anything up. Defend in 3 sentences.',
  ...
  },
  {
    ...
    studentTask: 'Recompute the ISO-NE effective output-basis factor (~0.246 kg CO₂/kWh) using the gridMix percentages and per-fuel factors. Discuss why it\'s ~1.5× cleaner than the US average (~0.37 kg/kWh), then compare your answer to EPA\'s published eGRID NEWE rate (0.246) and work out why the two differ.',
  ...
  },
  {
    ...
    gradeBand: '12',
    durationMin: 50,
    summary: 'The dashboard reports KUA\'s net annual footprint as ~2,566 mtCO₂e with no uncertainty band. Pick three big inputs, assume each has a ±10–20% uncertainty, and propagate the combined band using the variance-addition rule.',
    learningGoals: [
  ...
  },
  {
    ...
    studentTask: '800-word essay on KUA\'s ~2,566 mtCO₂e net in the voice of Dillard, Carson, or Leopold. Margin notes annotate at least 5 places where you made a stylistic choice + why.',
  },
  {
