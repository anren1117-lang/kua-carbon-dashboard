  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.breakdownSection}>
        <h2 style={styles.sectionTitle}>Emissions by Source (All 5 Sources)</h2>
        ...
        <div style={styles.totalRow}>
          <span>TOTAL</span>
          <span>{yearlyEmissions.toFixed(2)} mtCO2e</span>
        </div>
      </div>
      <div style={styles.infoSection}>
        <h2 style={styles.sectionTitle}>KUA Electricity Data</h2>
        <div style={styles.infoGrid}>
          <div style={styles.infoItem}>
            <span style={styles.infoLabel}>Total Electricity:</span>
            <span style={styles.infoValue}>2,316,469 kWh</span>
          </div>
          <div style={styles.infoItem}>
            <span style={styles.infoLabel}>Annual Cost:</span>
            <span style={styles.infoValue}>$347,470</span>
          </div>
          <div style={styles.infoItem}>
            <span style={styles.infoLabel}>Cost per kWh:</span>
            <span style={styles.infoValue}>$0.15</span>
          </div>
          <div style={styles.infoItem}>
            <span style={styles.infoLabel}>Data Year:</span>
...
const styles = {
  ...
  liveIndicator: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', marginTop: '10px', color: '#22c55e' },
  liveDot: { width: '10px', height: '10px', borderRadius: '50%' },
  mainCounter: { textAlign: 'center', backgroundColor: '#1e293b', borderRadius: '16px', padding: '30px', marginBottom: '30px' },
  ...
  toggleButton: { marginTop: '15px', padding: '10px 20px', fontSize: '1rem', backgroundColor: '#334155', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer' },
  cardsContainer: { display: 'flex', justifyContent: 'center', gap: '15px', flexWrap: 'wrap', marginBottom: '30px' },
  card: { backgroundColor: '#1e293b', borderRadius: '12px', padding: '20px', textAlign: 'center', minWidth: '120px' },
  ...
  breakdownSection: { maxWidth: '600px', margin: '0 auto 30px auto', backgroundColor: '#1e293b', borderRadius: '12px', padding: '25px' },
  sectionTitle: { fontSize: '1.2rem', color: '#22c55e', marginBottom: '20px' },
  barContainer: { marginBottom: '15px' },
  barLabel: { display: 'flex', justifyContent: 'space-between', marginBottom: '5px', fontSize: '0.85rem', color: '#e2e8f0' },
  barBackground: { height: '20px', backgroundColor: '#334155', borderRadius: '10px', overflow: 'hidden' },
  totalRow: { display: 'flex', justifyContent: 'space-between', marginTop: '20px', paddingTop: '15px', borderTop: '1px solid #334155', fontSize: '1rem', fontWeight: 'bold', color: '#22c55e' },
  infoSection: { maxWidth: '600px', margin: '0 auto 30px auto', backgroundColor: '#1e293b', borderRadius: '12px', padding: '25px' },
  infoGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' },
  infoItem: { display: 'flex', justifyContent: 'space-between', padding: '10px', backgroundColor: '#334155', borderRadius: '8px' },
  infoLabel: { color: '#94a3b8', fontSize: '0.85rem' },
  infoValue: { color: '#22c55e', fontWeight: 'bold', fontSize: '0.9rem' },
  footer: { textAlign: 'center', color: '#64748b', fontSize: '0.8rem', marginTop: '20px' }
};
