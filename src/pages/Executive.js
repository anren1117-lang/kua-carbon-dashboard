      ...
      >
        ...
        <div style={execProvStyles.list}>
          ...
          <ExecProvRow
            ...
            today="Scope 1 (~1,250 mt central, range 891–1,867 across 3 methods × 3 components) + Scope 2 (cited from BMS-measured kWh × ISO-NE 2024 per-fuel output factors × ~2.5 seasonally-anchored annualization, ±5% measured band) + Scope 3 (~2,700 mt central, range 1,754–3,764 across 3-4 methods × 8 components). See /admin/methodology for the per-component method-by-method breakdown."
