    ...
    <div style={styles.page} className="annual-report">
      ...
      <Section title="Methodology notes">
        <ul style={styles.notes}>
          <li><strong>Source factors.</strong> Electricity uses ISO-NE 2024 system mix (~0.0956 kg CO₂/kWh). Heating fuel uses EPA Greenhouse Gas Emission Factors Hub. Food uses Poore & Nemecek (2018). Waste uses EPA WARM v15. Procurement uses US EPA EEIO v2.0 spend-based.</li>
