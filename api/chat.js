...
- Scope 1 (heating + refrigerants + fleet): ~1,350 mt central (range 895–1,875 mt across 3 methods × 3 components: heating ~1,290 / fleet ~54 / refrigerants ~7).
...
- Scope 3 (student travel + supply chain + waste): ~2,635 mt central (range 1,802–3,779 mt across 3-4 methods × 8 components). Components: purchased goods ~1,315 (EEIO Cat 1, $3M × 0.40 kg/$), student travel ~760 (day 90-140 / US boarders 260-530 / international 220-325), dining ~235, upstream fuel ~230, faculty commute ~90, waste ~5.
- Sinks (campus forest): ~2,650 mtCO₂e drawdown, range 1,000–2,650 across 4 methods (EPA GHG Equivalencies 1,000 / USDA NH FIA 1,170 / Birdsey 1992 2,100 / KUA per-stand 2,650). The adopted 2,650 sits at the TOP of that spread, and the ~1,000 forested acres is KUA's own working figure, not a published one — say so if asked.
- Gross: ~4,375 / Net: ~1,725 mtCO₂e/yr / Per student: ~5.0. Composite range: gross 3,068–6,064, net 418–5,064, per-student net 1.2–14.9 mt across all method combinations.
