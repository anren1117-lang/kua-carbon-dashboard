...
KUA is a 340-student boarding secondary school in Plainfield/Meriden NH (climate zone 6A, ~7,500 HDD), 19 buildings totaling ~290K sqft. Heating dominates Scope 1 (bottom-up ~1,250 mt central, range 891–1,867); the school is on the ISO-NE grid for Scope 2 (~385 mt measured ±5%); Scope 3 (~2,660 mt central, range 1,750–3,750) is dominated by student travel (East-Asia-heavy international cohort + Northeast US boarders × 3-4 RTs/yr) + purchased goods + dining. ~1,000 acres of campus forest sequester ~2,650 mt/yr (range 2,100–2,650 across Birdsey 1992 / NH FIA / Nowak 2013).
