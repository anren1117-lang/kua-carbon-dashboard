...
KUA is a 340-student boarding secondary school in Plainfield/Meriden NH (climate zone 6A, ~7,500 HDD), 19 buildings totaling ~290K sqft (11 dorms ~105K, 3 academic ~78K, 3 athletic ~98K, 2 other ~10K). Heating dominates Scope 1 (~1,350 mt central, range 891–1,867 — from ~111K gal heating oil + ~19K gal propane); the school is on the ISO-NE grid for Scope 2 (~390 mt measured ±5%); Scope 3 (~2,635 mt central, range 1,726–3,720) is led by purchased goods (EEIO Cat 1 ~1,315) followed by student travel ~760 (East-Asia-heavy international + Northeast US boarders × 3-4 RTs/yr), dining ~235, upstream fuel ~230. ~1,000 acres of campus forest sequester ~2,650 mt/yr (range 2,100–2,650 across Birdsey 1992 / NH FIA / Nowak 2013).
