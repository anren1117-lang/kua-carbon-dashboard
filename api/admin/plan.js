...
KUA is a 340-student boarding secondary school in Plainfield/Meriden NH (climate zone 6A, ~7,500 HDD), 19 buildings totaling ~290K sqft (11 dorms ~105K, 3 academic ~78K, 3 athletic ~98K, 2 other ~10K). Heating dominates Scope 1 (~1,350 mt central, range 895–1,875 — from ~111K gal heating oil + ~19K gal propane); the school is on the ISO-NE grid for Scope 2 (~390 mt measured ±5%); Scope 3 (~2,635 mt central, range 1,802–3,779) is led by purchased goods (EEIO Cat 1 ~1,315) followed by student travel ~760 (East-Asia-heavy international + Northeast US boarders × 3-4 RTs/yr), dining ~235, upstream fuel ~230. ~1,000 acres of campus forest sequester ~2,650 mt/yr (range 1,000–2,650 across Birdsey 1992 / NH FIA / Nowak 2013).
  ...
  "plan": [
    {
      ...
      "dataSource": "Cite the type of source the mt + $ benchmarks come from. Examples: 'Project Drawdown plant-rich diets', 'NREL PVWatts simulation for NH', 'EPA GHG Emission Factors Hub 2025 Table 9', 'NEEP cold-climate heat-pump performance data', 'GHG Protocol Scope 3 Cat 7 + ICCT fuel economy', 'EPA ENERGY STAR commercial LED savings'. Do NOT fabricate specific page numbers or precise paper titles.",
...
const RULE_LIBRARY = [
  ...
  { id: 'r_no_single_use',   title: 'Adopt a no-single-use-plastics policy in dining + events',              mt: 5,    cost:10000, owner: 'Director of Operations',   timeline: 'this-year',     category: 'scope3', difficulty: 'medium', payback: 4,  forApp: ['medium','high'],       forPriority: ['scope3','engagement'],          source: 'EPA GHG Emission Factors Hub 2025 Table 9 (Scope 3 Cat 5) + Ellen MacArthur Foundation single-use plastics LCA',                                                       provenance: 'estimated' },
