...
KUA is a 340-student boarding secondary school in Plainfield/Meriden NH (climate zone 6A, ~7,500 HDD), 19 buildings totaling ~290K sqft (11 dorms ~105K, 3 academic ~78K, 3 athletic ~98K, 2 other ~10K). Heating dominates Scope 1 (~1,250 mt dashboard placeholder; bottom-up cross-check ~1,351 mt central, range 891–1,867 — from ~111K gal heating oil + ~19K gal propane); the school is on the ISO-NE grid for Scope 2 (~385 mt measured ±5%); Scope 3 (~2,700 mt dashboard placeholder; bottom-up cross-check ~2,635 mt central, range 1,726–3,720) is dominated by student travel (East-Asia-heavy international cohort + Northeast US boarders × 3-4 RTs/yr) + purchased goods + dining. ~1,000 acres of campus forest sequester ~2,650 mt/yr (range 2,100–2,650 across Birdsey 1992 / NH FIA / Nowak 2013).
