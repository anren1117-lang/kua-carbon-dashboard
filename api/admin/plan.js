...
KUA is a 340-student boarding secondary school in Meriden, NH. Heating dominates Scope 1; the school is on the ISO-NE grid for Scope 2; Scope 3 is dominated by international + US-boarder term-break travel and dining services. ~1,000 acres of campus forest sequester ~2,650 mt/yr.
...
const RULE_LIBRARY = [
  ...
  { id: 'r_recs',            title: 'Buy NH-class-1 RECs to cover 100% of remaining grid scope-2',           mt: 395,  cost:120000,owner: 'Director of Operations',   timeline: 'this-year',     category: 'scope2', difficulty: 'easy',   payback: 0,  forApp: ['low','medium','high'], forPriority: ['scope2','engagement'],          source: 'NEPOOL GIS REC market price (~$70/MWh) × KUA annualized scope-2 kWh (~1.7M kWh × $0.07 ≈ $120K/yr)',                          provenance: 'cited' },
];
